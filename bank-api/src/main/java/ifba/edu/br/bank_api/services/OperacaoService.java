...
public class OperacaoService {
    ...
    return "Pagamento '" + descricao + "' realizado com sucesso. Novo saldo: R$ " + conta.getSaldo();
     ...
     public Page<OperacaoResponseDTO> extrato(Long accountId, TipoOperacao tipo, LocalDateTime inicio, LocalDateTime fim, Pageable pageable) {
        ...
        // A vari·vel 'operacoes' agora È do tipo Page<Operacao> para corresponder ao retorno do repositÛrio.
        ...
        // O objeto Page j· possui um mÈtodo .map() que converte seu conte˙do.
        // Isso È mais eficiente do que converter para stream.
